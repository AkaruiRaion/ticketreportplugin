 ...
 * -------------------------------------------------------------------------
 * front/user.dropdown.php
 *
 * Назначение файла:
 * Возвращает HTML-разметку выпадающего списка с пользователями при
 * выборе группы пользователей в форме front/report.php
 * -------------------------------------------------------------------------
 */
...
if ($groupsId > 0) {
    ...
    Dropdown::showFromArray('users_id', $user_list, [
        'value'     => 0,
        'emptylabel' => __('Все пользователи'),
